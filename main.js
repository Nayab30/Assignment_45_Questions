...
let member = ['Sana', 'Sara', 'Zoya', 'Nida'];
...
let favoriteFruit = ["apple", "grapes", "mango"];
...
let cUser = ["user1", "user2", "user3", "user4"];
let nUser = ["user5", "user2", "user6"];
nUser.forEach(nUser => {
...
//Question 34 (Pizzas)
let pizza = ["Arabic ranch", "Fajita", "Chiken Tarzen"];
pizza.forEach(pizza => {
...
//Question 45 (cars)
function cars(model, name, color) {
